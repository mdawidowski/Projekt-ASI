...
class QuestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post quests_url, params: { quest: { answergood: @quest.answergood, answerone: @quest.answerone, answerthree: @quest.answerthree, answertwo: @quest.answertwo, description: @quest.description } }
    end
  ...
  test "should update quest" do
    patch quest_url(@quest), params: { quest: { answergood: @quest.answergood, answerone: @quest.answerone, answerthree: @quest.answerthree, answertwo: @quest.answertwo, description: @quest.description } }
